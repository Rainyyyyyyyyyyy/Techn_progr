...
QT_MOC_LITERAL(1, 12, 8), // "FileLost"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 11), // "SizeChanged"
QT_MOC_LITERAL(4, 34, 7), // "newSize"
QT_MOC_LITERAL(5, 42, 17) // "CheckStateOfFiles"

    },
    "FileMonitor\0FileLost\0\0SizeChanged\0"
    "newSize\0CheckStateOfFiles"
};
...
void FileMonitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->FileLost(); break;
        case 1: _t->SizeChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->CheckStateOfFiles(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FileMonitor::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileMonitor::FileLost)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FileMonitor::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileMonitor::SizeChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void FileMonitor::SizeChanged(int _t1)
{
