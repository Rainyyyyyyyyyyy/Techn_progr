...
Вариант запуска через Qt Creator:
...
Вариант сборки из консоли:

1. выполнить `qmake` для файла проекта;
2. собрать проект через `make` или `mingw32-make` в зависимости от среды;
